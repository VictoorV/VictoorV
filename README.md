...
|--------|-------------|-------------|
| [✨ Détection du cancer du sein](https://github.com/VictoorV/Breast_cancer) | Python, PyTorch, ResNet50, Scikit-learn | - Visualisation et analyse d'immages de mammographie.<br>- Transfer learning sur le modèle ResNet50 pour effectuer une tâche de classification.<br>- Optimisation des hyperparamètres.|
