...
|--------|-------------|-------------|
| [✨ Détection du cancer du sein](https://github.com/VictoorV/Breast_cancer) | Python, PyTorch, ResNet50, ConvNeXt, EfficientNet, Scikit-learn, CNN | - Visualisation et analyse d'immages de mammographie.<br>- Transfer learning sur des architectures CNN pour effectuer une tâche de classification.<br>- Optimisation des hyperparamètres.|
